package instanceandstaticmethods;
...
public class Instance_Static_Methods {
    int a = 10; //Declared Instance variable or Global variable

    float b = 20.10f; //Declared Instance variable
    static  double c = 25.25d; //Declared static variable or Global variable
    ...
    public static void m2()// Declared Static method
    {
    ...
    public static void main(String[] args) {  //Main method Or Predefined method
     Instance_Static_Methods a = new Instance_Static_Methods();  //Create an Object
